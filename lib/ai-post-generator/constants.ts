...
export const DEFAULT_GENERATORS: Array<
  Omit<AiPostGeneratorRow, "id" | "created_at" | "updated_at">
> = [
  {
    target_key: "summary",
    label: "摘要生成",
    ...
    prompt:
      "你是资深中文编辑。请根据文章标题和正文内容，写一段会让人想继续读下去的中文摘要。重点不是机械概括，而是先提炼文章真正讨论的问题、矛盾、反常识点或关键洞见，再用自然导语式语言把读者带进去。要求：1. 必须忠于正文，不夸张、不编造；2. 尽量保留具体主题词，让人一眼知道文章在讲什么；3. 像高质量专栏导语，不要像 AI 总结，不要出现“本文/这篇文章/作者认为”等套话；4. 可以保留一点张力或悬念，但不能标题党；5. 输出一段完整中文，不要分点，不要加引号。",
  ...
  },
  {
    ...
    prompt:
      "你是中文编辑。请优先根据正文主线，再结合标题校准语义，提取 3-5 个最能代表主题、对象、方法、技术、产品、人物、议题或领域的中文标签。优先具体概念、专有主题和有辨识度的短词，避免空泛大词、整句、重复词、泛泛分类词，以及“思考”“方法”“问题”这类过宽标签。",
    provider_mode: "workers_ai",
    text_profile_id: null,
    image_profile_id: null,
    workers_model: DEFAULT_TEXT_WORKERS_MODEL,
