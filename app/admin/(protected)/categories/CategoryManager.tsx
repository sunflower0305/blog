...
export function CategoryManager({ initialCategories }: { initialCategories: Category[] }) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      setCategories((prev) =>
        prev.map((c) =>
          c.slug === editingSlug ? { ...c, name: editName.trim(), slug: editSlugVal.trim() } : c,
        ),
      );
      setEditingSlug(null);
      toast.success("分类已更新");
            ...
            >
              {editingSlug === cat.slug ? (
                <>
                  ...
                  />
                  <span className="text-xs text-[var(--editor-muted)] text-right tabular-nums">
                    {cat.post_count}
                  </span>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="text-xs text-[var(--editor-muted)] hover:underline"
                    >
                      取消
                    </button>
                  </div>
