          ...
          <>
            <div className="space-y-0">
              {posts.map((post, index) => (
                ...
                >
                  <div className="py-6 sm:py-7 transition-all duration-200 hover:bg-[var(--editor-panel)] border-l-2 border-l-transparent hover:border-l-[var(--editor-accent)] pl-4">
                    <div>
