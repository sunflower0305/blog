...
export function HomeVariantA({
  ...
  return (
    <div
      className="theme-home-refined min-h-full flex flex-col"
      style={{ background: "var(--background)" }}
    >
      <SiteHeader initialTheme={initialTheme} navLinks={navLinks} categories={categories} />

      <main
        className="refined-home-main flex-1 mx-auto w-full"
        style={{ maxWidth: 860, padding: "0 32px 120px" }}
      >
        {/* Post list */}
        {posts.length === 0 ? (
          <div
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        {post.category && (
                          <div
                            className="refined-post-category"
                            style={{
                              display: "flex",
                              alignItems: "center",
                              gap: 6,
