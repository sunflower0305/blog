...
function EditorialNavBar({
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" style={{ color: FG, textDecoration: "none" }}>
          首页
        </Link>
        {links.map((link) =>
...
export function HomeVariantB({
  ...
  return (
    <div
      className="theme-home-editorial"
      style={{
        background: BG,
        color: FG,
        minHeight: "100vh",
      ...
      <main>
        ...
        >
          <Link href="/" style={{ textDecoration: "none", color: "inherit" }}>
            <h1
              className="editorial-masthead-title"
              style={{
                margin: 0,
            ...
            >
              乐扬<span style={{ color: ACCENT }}>·</span>博客
            </h1>
          </Link>
          <div
            className="editorial-masthead-meta"
            style={{
              display: "flex",
              justifyContent: "space-between",
              marginTop: 20,
            ...
            <Link href={`/${featured.slug}`} style={{ textDecoration: "none", color: "inherit" }}>
              ...
              >
                <div>
                  ...
                  <div
                    className="editorial-featured-meta"
                    style={{
                      marginTop: 20,
                      display: "flex",
                      gap: 16,
                ...
                {/* Decorative block */}
                <div
                  className="editorial-featured-art"
                  style={{
                    width: 200,
                    aspectRatio: "4/5",
        ...
        {rest.length > 0 && (
          <section className="editorial-index" style={{ padding: "44px 48px", paddingBottom: 80 }}>
            ...
            <div
              className="editorial-index-grid"
              style={{
                display: "grid",
