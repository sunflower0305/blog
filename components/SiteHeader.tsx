  ...
  const renderLogo = () => {
    if (theme === "terminal") {
      return (
        ...
        >
          ...
          />
          <span style={{ color: "var(--editor-muted)" }}>leyang@blog:~$</span>
      ...
      return (
        <div className="flex items-baseline gap-4 flex-shrink-0" suppressHydrationWarning>
          <Link
            ...
            style={{
              fontFamily: 'var(--logo-font, "Noto Serif SC", Georgia, serif)',
            }}
          >
            乐扬博客
          </Link>
    ...
    return (
      <Link
        ...
        style={{
          fontFamily: 'var(--logo-font, Georgia, "Noto Serif SC", serif)',
        }}
      >
        乐扬博客
      </Link>
    ...
    >
      ...
      <div
        className={`
          ...
          ${
            mobileMenuOpen
              ? "max-h-[70vh] overflow-visible border-t border-[var(--editor-line)]"
